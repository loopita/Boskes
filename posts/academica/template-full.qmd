...
You can use LaTeX math expressions: [@dewar]
...
I choose a mathematical font which supports the indicator function $\mathbb{1}\{\cdot\}$. Currently, I use the {{< meta mathfont >}} font. [@Equihua2020]
